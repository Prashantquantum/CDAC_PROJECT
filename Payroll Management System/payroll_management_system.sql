...
--
-- Host: 127.0.0.1
-- Generation Time: May 07, 2023 at 03:14 PM
...
(447, 'sadf', 'asdf@asfdc.com', 'asdf', '1');
...
CREATE TABLE `leaves` (
  ...
  `leave_employee_id` varchar(255) DEFAULT NULL,
  ...
  `leave_total_days` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
ALTER TABLE `feedback`
  MODIFY `feedback_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=448;
